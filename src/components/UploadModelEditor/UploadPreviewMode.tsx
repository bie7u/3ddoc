        ...
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-xl hover:from-purple-600 hover:to-pink-700 transition-all duration-200 shadow-xl font-medium"
            >
            ...
            {viewMode === 'view' && onGoToEditorPanel && (
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-xl font-medium"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => setPreviewMode(false)}
              className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-xl hover:from-red-600 hover:to-rose-700 transition-all duration-200 shadow-xl font-medium"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-center min-w-[140px] px-4">
              ...
              <div className="text-2xl font-bold text-blue-300">
                {currentPreviewStepIndex + 1} / {steps.length}
              </div>
            </div>
              ...
              <button
                ...
                className={`rounded-full transition-all duration-200 ${
                  index === currentPreviewStepIndex
                    ? 'w-8 h-3 bg-gradient-to-r from-blue-400 to-indigo-500 shadow-lg'
